...
def check_win(smb):         # проверка победы по всем направлениям
    for n in range(3):
...
# на входе три поля и символ, если символ есть в этих трех полях, то меняем цвет полей на розовый и остановка игры
